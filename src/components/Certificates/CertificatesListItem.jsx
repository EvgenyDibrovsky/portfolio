...
export default function CertificatesListItem({ item }) {
  ...
  return (
    <>
      <AnimateElements>
        <li className="flex flex-col xl:flex-row h-full border border-colorBorder dark:border-colorBorderDark rounded-md group overflow-hidden opacity-0 init-animate-1">
          <img
