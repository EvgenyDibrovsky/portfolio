...
export default function NavMenuItem({ to, labelKey }) {
  ...
  return (
    <li className="w-full border-b border-r  border-b-colorBorder border-r-transparent last:border-b-0 text-center hover:border-r-orange-400 group dark:border-b-colorBorderDark">
      <Link
        to={to}
