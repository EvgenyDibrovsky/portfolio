        ...
        {({ errors, touched, isSubmitting }) => (
          <Form>
            ...
            <div className="grid grid-cols sm:grid-cols-2 lg:grid-cols-3 mb-5 gap-4">
              ...
              <label className="flex items-center gap-2 text-black dark:text-white">
                <Field type="checkbox" name="website_type" value="e_shop" className="form-checkbox focus:ring-0 focus:ring-offset-0 border bg-white border-orange-400  text-orange-400 dark:bg-black" />
                {t('brief-form.e-shop')}
              </label>
              <label className="flex items-center gap-2 text-black dark:text-white">
                <Field type="checkbox" name="website_type" value="portal" className="form-checkbox focus:ring-0 focus:ring-offset-0 border bg-white border-orange-400  text-orange-400 dark:bg-black" />
            ...
            <div className="grid grid-cols sm:grid-cols-2 lg:grid-cols-3 mb-5 gap-4">
              ...
              <label className="flex items-center gap-2 text-black dark:text-white">
                <Field type="checkbox" name="marketing_type" value="seo" className="form-checkbox focus:ring-0 focus:ring-offset-0 border bg-white border-orange-400  text-orange-400 dark:bg-black" />
