...
export default function ContactDetails() {
  ...
  return (
    <AnimateElements>
      <ul className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
        <li className="flex justify-start xl:justify-center items-center gap-4 lg:flex-col xl:flex-row bg-bgCardsTop/80 dark:bg-neutral-900/80 shadow-sm shadow-black dark:shadow-white px-10 py-6 lg:py-10 opacity-0 init-animate-1">
