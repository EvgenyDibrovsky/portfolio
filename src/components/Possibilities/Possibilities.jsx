      ...
      <ul className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        <li className="flex flex-col lg:flex-row gap-4">
          <div className="w-12 h-12 mx-auto">
            <BsBrush className="w-12 h-12 text-orange-400" />
          </div>
          <div>
        ...
        <li className="flex flex-col lg:flex-row gap-4">
          <div className="w-12 h-12 mx-auto">
            <BsGlobeEuropeAfrica className="w-12 h-12 text-orange-400" />
          </div>
          <div>
        ...
        <li className="flex flex-col lg:flex-row gap-4">
          <div className="w-12 h-12 mx-auto">
            <BsRocketTakeoff className="w-12 h-12 text-orange-400" />
          </div>
          <div>
        ...
        <li className="flex flex-col lg:flex-row gap-4">
          <div className="w-12 h-12 mx-auto">
            <BsPeople className="w-12 h-12 text-orange-400" />
          </div>
          <div>
