      ...
      <AnimateElements>
        <ul className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-6">
          <li className="flex flex-col lg:flex-row gap-4 opacity-0 init-animate-1">
            ...
            <div>
              <h3 className="text-center lg:text-left text-[1rem] lg:text-[1.25rem] font-semibold text-textColor dark:text-white mb-2">{t('possibilities.web-development')}</h3>
          ...
          <li className="flex flex-col lg:flex-row gap-4 opacity-0 init-animate-1">
            ...
            <div>
              <h3 className="text-center lg:text-left text-[1rem] lg:text-[1.25rem] font-semibold text-textColor dark:text-white mb-2">{t('possibilities.web-design')}</h3>
          ...
          <li className="flex flex-col lg:flex-row gap-4 opacity-0 init-animate-1">
            ...
            <div>
              <h3 className="text-center lg:text-left text-[1rem] lg:text-[1.25rem] font-semibold text-textColor dark:text-white mb-2">{t('possibilities.e-marketing')}</h3>
          ...
          <li className="flex flex-col lg:flex-row gap-4 opacity-0 init-animate-1">
            ...
            <div>
              <h3 className="text-center lg:text-left text-[1rem] lg:text-[1.25rem] font-semibold text-textColor dark:text-white mb-2">{t('possibilities.seo')}</h3>
          ...
          <li className="flex flex-col lg:flex-row gap-4 opacity-0 init-animate-1">
            ...
            <div>
              <h3 className="text-center lg:text-left text-[1rem] lg:text-[1.25rem] font-semibold text-textColor dark:text-white mb-2">{t('possibilities.site-availability')}</h3>
          ...
          <li className="flex flex-col lg:flex-row gap-4 opacity-0 init-animate-1">
            ...
            <div>
              <h3 className="text-center lg:text-left text-[1rem] lg:text-[1.25rem] font-semibold text-textColor dark:text-white mb-2">{t('possibilities.technical-support')}</h3>
