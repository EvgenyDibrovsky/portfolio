        ...
        <span className="flex items-center">
          <label className="flex items-center">
            <input
              ...
              onChange={this.handleChange}
              required
              className="mr-4 appearance-none inline-block h-4 w-4 border-4 border-white dark:border-black rounded outline outline-2 outline-checkboxColor dark:outline-orange-400 bg-white dark:bg-black  checked:bg-checkboxColor dark:checked:bg-orange-400  "
            />
            {t('agreed')}
          </label>
          <a
