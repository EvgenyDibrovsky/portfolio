    ...
    >
      <div className="relative flex items-center justify-center cursor-pointer">
        <picture>
          ...
          <img src={process.env.PUBLIC_URL + image} alt={name} className="w-full h-auto object-cover transition-transform duration-200 ease-in-out group-hover:scale-110" />
        </picture>
