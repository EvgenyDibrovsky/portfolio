...
export default function PortfolioFilter({ onFilterChange }) {
  ...
  return (
    <AnimateElements>
      <ul className="flex flex-col xl:flex-row items-center justify-end gap-4 mb-4 w-full xl:w-8/12 xl:ml-auto opacity-0 init-animate-4" data-time="1.2s" data-delay="0.5s">
        <li
