      ...
      <div className="w-full xl:w-6/12 py-12 px-4 xl:px-16 gap-8 flex flex-col justify-center items-center">
        <div>
          ...
          <div className="">
            ...
            <p className="text-[1.25rem] text-black dark:text-white mb-4 ">{t('about-me.description-3')}</p>
            <p className="text-[1.25rem] text-black dark:text-white mb-4 italic underline">{t('about-me.description-4')}</p>
          </div>
