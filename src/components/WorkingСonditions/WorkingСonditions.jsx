  ...
  return (
    <AnimateElements>
      <ul className="grid grid-cols-1 lg:grid-cols-3 gap-6 justify-center">
        <li className="flex justify-center items-center gap-4 lg:flex-col xl:flex-row  border border-colorBorder dark:border-colorBorderDark py-5 lg:py-10 opacity-0 init-animate-1">
